 ...
 */
final class Version20231023103235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE arme_arm (arm_id INT AUTO_INCREMENT NOT NULL, arm_fk_typ_id INT NOT NULL, arm_fk_tai_id INT NOT NULL, arm_nom VARCHAR(255) NOT NULL, arm_degat VARCHAR(255) DEFAULT NULL, arm_mains INT DEFAULT NULL, arm_portee INT DEFAULT NULL, arm_effet VARCHAR(255) DEFAULT NULL, arm_poids DOUBLE PRECISION NOT NULL, arm_prix INT NOT NULL, INDEX IDX_135DE2852614F082 (arm_fk_typ_id), INDEX IDX_135DE2855B9534D4 (arm_fk_tai_id), PRIMARY KEY(arm_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_arme_typ (typ_id INT AUTO_INCREMENT NOT NULL, typ_libelle VARCHAR(255) NOT NULL, PRIMARY KEY(typ_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE arme_arm ADD CONSTRAINT FK_135DE2852614F082 FOREIGN KEY (arm_fk_typ_id) REFERENCES type_arme_typ (typ_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE type_arme_typ');
